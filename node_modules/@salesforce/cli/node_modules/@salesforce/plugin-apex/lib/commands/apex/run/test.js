...
export default class Test extends SfCommand {
    ...
    async runTestAsynchronous(testService, flags, testLevel) {
        ...
        try {
            ...
            return (await testService.runTestAsynchronous(payload, flags['code-coverage'], flags.wait && flags.wait.minutes > 0 ? false : !(flags.synchronous && !this.jsonEnabled()), undefined, this.cancellationTokenSource.token, flags.wait));
        }
        catch (e) {
            throw handleTestingServerError(SfError.wrap(e), flags, testLevel);
        }
...
function handleTestingServerError(error, flags, testLevel) {
