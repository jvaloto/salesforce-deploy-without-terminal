...
export default class LoginWeb extends SfCommand {
    ...
    async executeLoginFlow(oauthConfig, browser, app, username, scopes) {
        ...
        await open(oauthServer.getAuthorizationUrl(), openOptions).then((childProcess) => new Promise((resolve, reject) => {
