...
export class TestResultsFormatter {
    result;
    flags;
    skipVerboseTestReportOnCI;
    testLevel;
    verbosity;
    constructor(result, flags, skipVerboseTestReportOnCI = true) {
        this.result = result;
        this.flags = flags;
...
export const testResultSort = (a, b) => a.methodName === b.methodName ? a.name.localeCompare(b.name) : a.methodName.localeCompare(b.methodName);
