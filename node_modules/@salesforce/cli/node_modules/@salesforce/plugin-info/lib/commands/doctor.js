...
export default class Doctor extends SfCommand {
    ...
    async run() {
        ...
        if (flags['create-issue']) {
            ...
            const url = encodeURI(`https://github.com/forcedotcom/cli/issues/new?title=${title}&body=${this.generateIssueMarkdown(ghIssue.body, diagnosis)}&labels=doctor,investigating,${this.config.bin}&template=bug_report`)
