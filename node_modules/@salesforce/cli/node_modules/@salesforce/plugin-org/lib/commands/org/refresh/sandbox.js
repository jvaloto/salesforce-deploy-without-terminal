...
export default class RefreshSandbox extends SandboxCommandBase {
    ...
    async resolveConfig() {
        ...
        if (defFileContent.SourceSandboxName) {
            srcId = await requestFunctions.getSrcIdByName(this.flags['target-org'].getConnection(), defFileContent.SourceSandboxName);
        ...
        sandboxInfo = Object.assign(sandboxInfo, defFileContent, {
            ...
            ...(this.flags['source-sandbox-name']
                ? {
                    SourceId: await requestFunctions.getSrcIdByName(this.flags['target-org'].getConnection(), this.flags['source-sandbox-name']),
                }
